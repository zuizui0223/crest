...
finite carrier feasibility
    ↓
least-information adequate state J
    ↓
...
with full-state identification lost under fixed evidence while a coarse target remains reportable.
...
`../artifacts/crest_philosophy_submission_report.json`
...
See `biology_philosophy_submission_handoff.md` for the 2026-08-22 check against the official *Biology & Philosophy* Springer Nature submission guidelines.

Key constraints already encoded in the finishing path:
...
- 4–6 keywords;
- author/funding/disclosure material separated appropriately for blinded review;
- final human accountability for any declared LLM-assisted generative work.
...
1. complete the author-controlled title page and declarations;
2. perform final human source/claim/mathematics/prose review;
3. approve the final LLM disclosure;
4. produce the exact blinded review file and inspect it visually;
5. rerun the verifier/reproducibility suite on that exact candidate commit;
6. upload through the journal submission system.
